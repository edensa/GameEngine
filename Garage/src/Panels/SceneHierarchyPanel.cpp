...
namespace engine
{
	...
	static void DrawVec3Control(const std::string& label, glm::vec3& values, float resetValue = 0.0f, float coloumnWith = 100.0f)
	{
		...
		ImGui::SetColumnWidth(0, coloumnWith);
	...
	static void DrawComponent(const std::string& name, Entity entity, UIFunction function)
	{
		...
		if (entity.HasComponent<T>())
		{
			...
			ImVec2 contentRegionAvailble = ImGui::GetContentRegionAvail();
			...
			ImGui::PopStyleVar();
			ImGui::SameLine(contentRegionAvailble.x - lineHeight * 0.5f);
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity)
	{
		...
		if (ImGui::BeginPopup("AddComponent"))
		{
			...
			if (!m_SelectionContext.HasComponent<CircleRendererComponent>() && ImGui::MenuItem("Circle Renderer"))
			{
				m_SelectionContext.AddComponent<CircleRendererComponent>();
				ImGui::CloseCurrentPopup();
			}

			if (!m_SelectionContext.HasComponent<RigidBody2DComponent>() && ImGui::MenuItem("Rigidbody 2D"))
			{
				m_SelectionContext.AddComponent<RigidBody2DComponent>();
				ImGui::CloseCurrentPopup();
			}

			if (!m_SelectionContext.HasComponent<BoxCollider2DComponent>() && ImGui::MenuItem("Box Collider 2D"))
			{
		...
		DrawComponent<SpriteRendererComponent>("Sprite Renderer", entity, [](auto& component)
		{
			...
			ImGui::SliderFloat("Tiling Factor", &component.TilingFactor, 0.0f, 100.0f);
